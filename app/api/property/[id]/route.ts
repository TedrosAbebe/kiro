...
export async function GET(
  ...
  console.log('🏠 INDIVIDUAL PROPERTY API CALLED for ID:', params.id)
  ...
  try {
    ...
    try {
      ...
      if (params.id.startsWith('adv_')) {
        const advertiserPropertyId = params.id.replace('adv_', '')
      ...
      console.log('❌ Property not found or not approved:', params.id)
      return NextResponse.json({ 
